...
<% with DistrictInfo %>
<div id="captain-info" class="modal hide fade">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		<h4>$DistrictName Captain $DistrictCaptain</h4> 
	</div>
	<div class="modal-body">
	   <p style="float: left; margin: 0 15px 3px 0;">$DistrictCaptainPhoto</p>
		<p style="margin-top: -18px;">$DistrictCaptainBio</p>
	</div>
</div>
<% end_with %>
    <% include PageHeader %>
